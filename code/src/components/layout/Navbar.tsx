...
import { FileText, Sparkles, FileUser, Home, LogOut, ClipboardCheck, Calendar } from 'lucide-react';
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="/daily" className="flex items-center space-x-2 text-muted-foreground hover:text-primary cursor-pointer">
