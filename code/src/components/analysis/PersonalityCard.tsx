    ...
    <Card className="p-6 bg-accent border-accent">
      <div className="text-center mb-6">
        <div className="w-20 h-20 bg-primary rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
          <span className="text-2xl font-bold text-primary-foreground" aria-label={`성격 유형 ${personalityType.type}`}>{personalityType.type}</span>
        </div>
        <h2 className="text-2xl font-bold mb-2 text-foreground">{personalityType.type}</h2>
