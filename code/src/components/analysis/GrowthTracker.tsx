    ...
    <div className="space-y-6">
      ...
      {growthInsights && (
        <Card className="p-6 bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-green-700 mb-3">새로운 가치관</h4>
              {growthInsights.valuesEvolution.length > 0 ? (
                ...
                <p className="text-sm text-green-600">기존 가치관이 안정적으로 유지되고 있습니다.</p>
              )}
            </div>
            
            <div>
              <h4 className="font-medium text-green-700 mb-3">확장된 관심사</h4>
              {growthInsights.interestsExpansion.length > 0 ? (
                ...
                <p className="text-sm text-green-600">기존 관심사에 집중하고 있습니다.</p>
              )}
            </div>
          </div>
        </Card>
      ...
      <Card className="p-6">
        ...
        {filteredAnalyses.length === 0 ? (
          ...
          <div className="space-y-4">
            {filteredAnalyses.slice(0, 5).map((analysis, index) => (
              <div key={analysis.analysisId} className="flex items-center justify-between p-4 bg-accent rounded-lg">
            ...
            {filteredAnalyses.length > 5 && (
              <div className="text-center pt-4">
                <Button variant="outline" size="sm">
                  더 보기 ({filteredAnalyses.length - 5}개 더)
                </Button>
              </div>
            )}
          </div>
      ...
      {currentAnalysis && (
        <Card className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-blue-700 mb-3">단기 목표 (1개월)</h4>
            ...
            <div>
              <h4 className="font-medium text-blue-700 mb-3">장기 목표 (6개월)</h4>
              <ul className="space-y-2 text-sm text-blue-600">
